...
The software is for academic purposes only, see also the file license.md  provided. To compile the code it is necessary to update the path to the CPLEX directories in the files "global_functions.h"
